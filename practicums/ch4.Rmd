...
var scientist_names = ["scientist_1","scientist_2","scientist_3","scientist_4",
            "scientist_5","scientist_6","scientist_7"];

// 1/Math.sqrt(gamma(0.1, 1/0.1)),
var sampleSigma = function(){ return sample(Uniform({a:0, b:10})); }
...
//  })
  ...
  factor(sum(map(function(scientist){
    return Gaussian({mu: mu, sigma: sigmas[scientist]}).score(data[scientist])
  }, scientist_names)))
